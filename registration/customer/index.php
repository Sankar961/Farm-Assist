<?php
    ...
    if (isset($_POST["submit"]) && !empty($_POST))
    {
        ...
        $sql = 'SELECT * FROM customer_register WHERE emailid = :emailid';
        ...
        if($count > 0){
            ...
            //Insert data into the customer_register table
            $data = [
                'emailid' => $emailid,
            ...
            $sql = 'INSERT INTO customer_register(emailid, first_name, last_name, phoneno, housename, city, state, pincode, landmark, created_at) VALUES (:emailid, :first_name, :last_name, :phoneno, :housename, :city, :state, :pincode, :landmark, :created_at)';
            $stmt = $pdo -> prepare($sql);
            $stmt -> execute($data);
            $count = $stmt -> rowCount();
            if($count > 0){
                //Customer data successfully inserted. Now copy the email and password into the login table.
                $data = [
                    'emailid' => $emailid, 
                    'password' => $password, 
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="EMAIL ID" name="emailid" required>
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="FIRST NAME" name="first_name" required>
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="LAST NAME" name="last_name" required>
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="PHONE NO" name="phoneno" required>
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="HOUSE NAME" name="housename" required>
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="PINCODE" name="pincode" required>
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="LANDMARK" name="landmark" required>
                        </div>
